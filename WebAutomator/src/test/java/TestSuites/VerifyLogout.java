...
public class VerifyLogout extends base{
	...
	public void init() throws IOException{
		extentReports = new ExtentReports("/Users/vamsiravi/git/seleniumtestngextent/WebAutomator/reports/TMTPVerifyLogoutReport.html");
	...
	@Test(enabled=true)
	public void verifyLogoutInformation() throws AWTException, IOException, InterruptedException{
...
//		password.sendKeys("July31-");
		...
		WebElement logoutVerifyElement = webDriver.findElement(By.xpath(".//*[@id='logoutText']/p[2]/a"));
		String logoutVerifyElementText = logoutVerifyElement.getText();
		String logoutVerifyElementExpected = "Return to the Lobby";
		if(logoutVerifyElementText.contains(logoutVerifyElementExpected)){
			String logoutVerifyElementPassScreenshotPath = GetScreenShot.capture(webDriver, "logoutVerifyElementPassScreenshotPath");
			test.log(LogStatus.PASS, "Verified the Logout Window Title"+test.addScreenCapture(logoutVerifyElementPassScreenshotPath));
		
		}else{
			String logoutVerifyElementFailScreenshotPath = GetScreenShot.capture(webDriver, "logoutVerifyElementFailScreenshotPath");
			test.log(LogStatus.PASS, "Verified the Logout Window Title"+test.addScreenCapture(logoutVerifyElementFailScreenshotPath));
